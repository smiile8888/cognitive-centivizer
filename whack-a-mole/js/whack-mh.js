window.onload = function() {
    ...
    /**
     * Construct the JSON file and download
     */
    function setJSON() {
        var date = new Date();
        var jsonObj = {};
    ...
    function peep() {
        ...
        if (randomMoleProb(moleHatProb/100)) {
            timeMoleUp = Date.now();
    ...
    function bonk(e) {
        ...
        // this.style.backgroundImage = 'block';
        // Check whether hitting the correct mole or not
        console.log(this.classList.contains('moleHat'));
        if (this.classList.contains('moleHat')) {
        ...
        setTimeout(() => {
            this.style.backgroundImage = "url('media/images/hole.png')";
        }, 300);
